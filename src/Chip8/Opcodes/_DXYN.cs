...
{
    public static ProgramCounterResult Execute(IRegisters registers, IAddressableMemory addressableMemory, IFrameBuffer frameBuffer, RegisterName x, RegisterName y, byte n)
    {
